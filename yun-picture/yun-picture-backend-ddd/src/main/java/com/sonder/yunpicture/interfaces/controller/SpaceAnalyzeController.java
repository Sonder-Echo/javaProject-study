...
import com.sonder.yunpicture.interfaces.dto.space.analyze.*;
import com.sonder.yunpicture.interfaces.vo.space.analyze.*;
import com.sonder.yunpicture.domain.space.entity.Space;
import com.sonder.yunpicture.domain.user.entity.User;
import com.sonder.yunpicture.application.service.SpaceAnalyzeApplicationService;
...
public class SpaceAnalyzeController {
    ...
    public BaseResponse<List<SpaceCategoryAnalyzeResponse>> getSpaceCategoryAnalyze(@RequestBody SpaceCategoryAnalyzeRequest spaceCategoryAnalyzeRequest, HttpServletRequest request) {
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        List<SpaceCategoryAnalyzeResponse> spaceCategoryAnalyzeResponse = spaceAnalyzeApplicationService.getSpaceCategoryAnalyze(spaceCategoryAnalyzeRequest, loginUser);
    ...
    public BaseResponse<List<SpaceTagAnalyzeResponse>> getSpaceTagAnalyze(
        ...
        User loginUser = userApplicationService.getLoginUser(request);
        List<SpaceTagAnalyzeResponse> spaceTagAnalyzeResponse = spaceAnalyzeApplicationService.getSpaceTagAnalyze(spaceTagAnalyzeRequest, loginUser);
