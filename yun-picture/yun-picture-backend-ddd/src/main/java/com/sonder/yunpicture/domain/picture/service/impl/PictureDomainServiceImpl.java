package com.sonder.yunpicture.domain.picture.service.impl;
...
import com.sonder.yunpicture.domain.picture.service.PictureDomainService;
...
import com.sonder.yunpicture.infrastructure.api.aliyunai.AliYunAiApi;
import com.sonder.yunpicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskRequest;
import com.sonder.yunpicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskResponse;
...
import com.sonder.yunpicture.infrastructure.utils.ColorSimilarUtils;
import com.sonder.yunpicture.infrastructure.utils.ColorTransformUtils;
import com.sonder.yunpicture.interfaces.dto.picture.*;
import com.sonder.yunpicture.interfaces.vo.picture.PictureVO;
import com.sonder.yunpicture.infrastructure.manager.upload.FilePictureUpload;
import com.sonder.yunpicture.infrastructure.manager.upload.PictureUploadTemplate;
import com.sonder.yunpicture.infrastructure.manager.upload.UrlPictureUpload;
import com.sonder.yunpicture.infrastructure.manager.upload.model.dto.file.UploadPictureResult;
...
//            }
            ...
            if (spaceId == null) {
                ...
                // 传入了 spaceId，必须要和原图片的 spaceId一致
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        for (Element imgElement : imgElementList) {
            ...
            try {
                ...
                log.info("第{}条处理【成功】：id = {}", uploadCount + 1, pictureVO.getId());
                ++uploadCount;
            } catch (Exception e) {
                log.info("图片上传失败：{}", fileUrl);
            }
...
//        checkPictureAuth(loginUser, oldPicture);
    ...
    public void editPictureByBatch(PictureEditByBatchRequest pictureEditByBatchRequest, User loginUser) {
        ...
        ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR, "空间不存在");
        if (!space.getUserId().equals(loginUser.getId())) {
            ThrowUtils.throwIf(true, ErrorCode.NO_AUTH_ERROR, "没有权限编辑该空间下的图片");
        }
        // 3.查询指定图片（仅选择需要的字段）
        List<Picture> pictureList = pictureRepository.lambdaQuery()
