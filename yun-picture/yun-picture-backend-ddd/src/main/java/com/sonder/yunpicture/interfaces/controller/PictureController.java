...
import com.sonder.yunpicture.infrastructure.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.sonder.yunpicture.infrastructure.api.imagesearch.ImageSearchApiFacade;
...
import com.sonder.yunpicture.interfaces.assembler.PictureAssembler;
import com.sonder.yunpicture.interfaces.dto.picture.*;
import com.sonder.yunpicture.shared.auth.SpaceUserAuthManager;
import com.sonder.yunpicture.shared.auth.StpKit;
import com.sonder.yunpicture.shared.auth.annotation.SaSpaceCheckPermission;
...
//            }
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> tagList = Arrays.asList("热门", "二次元", "搞笑", "生活", "高清", "艺术", "校园", "背景", "简历", "创意");
        List<String> categoryList = Arrays.asList("模板", "动漫", "电商", "表情包", "素材", "海报");
